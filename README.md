...
Omnipay is installed via [Composer](http://getcomposer.org/). To install, simply require `ynievesdotnetteam/omnipay-enzona` with Composer:

```bash
#!/bin/bash
composer require ynievesdotnetteam/omnipay-enzona
```
